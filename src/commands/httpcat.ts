...
export default {
    ...
    run: async (interaction) => {
        const statusCodes = [
            ...
            214, 226, 300, 301, 302, 303, 304, 305, 306, 307, 308, 400, 401,
            402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414,
            415, 416, 417, 418, 420, 422, 423, 424, 425, 426, 428, 429, 431,
            444, 450, 451, 497, 498, 499, 500, 501, 502, 503, 504, 505, 506,
            ...
            await interaction.reply({
                content: `${
                    code && !statusCodes.includes(code)
                        ? "Because your code doesn't exist, here's a random one :3\n"
                        : ''
                }https://http.cat/${
